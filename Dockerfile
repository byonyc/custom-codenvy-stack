...
#
# Copied from Codenvy Docker Repo - only modified to include Sails as part of NPM installation
...
RUN sudo npm install --unsafe-perm -g sails gulp bower grunt grunt-cli yeoman-generator yo generator-angular generator-karma generator-webapp
